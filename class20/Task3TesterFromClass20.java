...
public class Task3TesterFromClass20 {
	...
	//name
		...
		Task3 task1=new Task3("Shawn"); //CE because the constructor is private
		System.out.println(task1.name); //CE because the fields are also default
		...
		Task3 task2=new Task3("12"); //CE because constructor is default
